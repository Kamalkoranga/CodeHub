...
Revision ID: 828ec9bf03fd
Revises: 
Create Date: 2023-05-06 16:16:37.590358
...
def upgrade():
    ...
    with op.batch_alter_table('upload', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_upload_timestamp'), ['timestamp'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('upload', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_upload_timestamp'))
